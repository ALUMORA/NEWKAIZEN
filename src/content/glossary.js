...
const TERMS = {
  ...
  'interes-compuesto': {
    ...
    ejemplo: 'Cien mil pesos al 11.75 por ciento efectivo anual durante 10 años se vuelven 303,589 pesos, tres veces el capital.',
  ...
  'crecimiento-terminal': {
    ...
    ejemplo: 'Con flujo de 161.05, crecimiento terminal de 3 por ciento y WACC de 9 por ciento, el valor terminal es 2,764.36 antes de descontarlo.',
