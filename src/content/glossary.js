...
const TERMS = {
  ...
  var: {
    ...
    ejemplo: 'Veinte rendimientos de −5 a +14 por ciento dan VaR histórico al 95 por ciento de 5 por ciento. Con μ = 4.5 por ciento y σ = 5.9161 por ciento, la desviación muestral de esa misma serie, el paramétrico da 5.23 por ciento.',
  ...
  cvar: {
    ...
    ejemplo: 'Con μ = 4.5 por ciento y σ = 5.9161 por ciento, la desviación muestral de la serie, el CVaR paramétrico al 95 por ciento es 7.70 por ciento, contra un VaR de 5.23 por ciento.',
  ...
  'tasa-libre-de-riesgo': {
    ...
    largo: [
      ...
      'Cada periodo usa la tasa vigente al inicio, y esa tasa se arrastra hasta 45 días mientras no haya una publicación nueva. Es la única serie, junto con el tipo de cambio, que se rellena hacia adelante. Pasados los 45 días el periodo queda sin tasa y el Sharpe, el Sortino y el Treynor de ese tramo no se calculan: salen como s/d en vez de usar una tasa vieja.',
    ],
  ...
  hhi: {
    ...
    comoLeer: 'En escala de 0 a 1, abajo de 0.15 se lee repartido y arriba de 0.25 concentrado. Son los cortes de 1,500 y 2,500 puntos de las guías de fusiones estadounidenses de 2010, traídos desde la escala de 0 a 10,000 que usa el análisis de competencia. Para una cartera no existe umbral oficial: sirven como referencia, no como regla.',
    ejemplo: 'Pesos de 50, 30 y 20 por ciento dan HHI de 0.38, o sea concentrado.',
    fuente: 'Hirschman (1945) y Herfindahl (1950). Cortes de referencia: Horizontal Merger Guidelines (2010) del Departamento de Justicia y la FTC. La Comisión Federal de Competencia Económica también usa el HHI, con sus propios umbrales.',
  ...
  'ledoit-wolf': {
    ...
    ejemplo: 'En el panel de prueba de 60 semanas y 5 activos, delta sale 0.65: casi dos tercios de la matriz vienen de la estructura, no de los datos. Con 120 semanas y 8 activos baja a 0.24.',
  ...
  'walk-forward': {
    ...
    formula: 'Para cada bloque t: w_t = método(los últimos 156 periodos antes del bloque t);  resultado_t = w_t · rendimientos del bloque t',
  ...
  rebalanceo: {
    ...
    formula: 'Desviación = Σ |w_actual − w_objetivo|; se compran acciones enteras mientras la desviación baje y alcance el efectivo, y luego se cambian por pares (vender una de una emisora, comprar una de otra) mientras la desviación siga bajando',
  ...
  'bootstrap-por-bloques': {
    ...
    formula: 'Se eligen bloques circulares de b periodos consecutivos con reemplazo hasta cubrir el horizonte',
    ...
    ejemplo: 'Con bloques de 6 meses y 20 años de historia mensual hay 240 bloques posibles, uno por cada mes de arranque, porque los bloques son circulares: el que empieza en los últimos meses da la vuelta al principio.',
    fuente: 'Künsch (1989), The Jackknife and the Bootstrap for General Stationary Observations, Annals of Statistics. Variante circular: Politis y Romano (1992).',
  ...
  twr: {
    ...
    largo: [
      'Si metes dinero justo antes de una subida, tu saldo crece pero tu decisión de inversión no fue mejor. El TWR quita ese efecto: parte la historia en tramos, uno por fecha de valuación, le quita a cada tramo el dinero que entró o salió, y encadena los rendimientos multiplicando.',
    ...
    formula: 'TWR = Π ((V_fin_i − flujo_i) / V_ini_i) − 1: el flujo del tramo se resta del valor final, porque cuenta al cierre del tramo en que ocurre',
  ...
  'isr-ganancia-de-capital': {
    ...
    largo: [
      ...
      'Kaizen presenta esto como una estimación, siempre etiquetada. Sí actualiza el costo por inflación con el INPC, pero no conoce tus operaciones fuera de la plataforma ni tu situación fiscal completa, y cuando le falta el INPC de algún mes usa el costo sin actualizar y lo dice. No sustituye a un contador.',
    ],
    formula: 'ISR estimado = 10% × max(0, ganancia neta del ejercicio − pérdidas pendientes de hasta 10 ejercicios anteriores), con ganancia neta = Σ (producto de venta − costo actualizado)',
  ...
  'retencion-por-dividendos': {
    ...
    largo: [
      ...
      'Este 10 por ciento no cubre a las FIBRAs. Sus distribuciones siguen el artículo 188: la retención es a la tasa del artículo 9, 30 por ciento sobre la parte que viene del resultado fiscal, y para una persona física es un pago a cuenta de la anual, no un pago definitivo.',
    ],
    ...
    fuente: 'Ley del Impuesto sobre la Renta, art. 140. Para extranjeras, art. 142, fracción V (10 por ciento adicional en México), y el tratado para evitar la doble imposición que aplique.',
  ...
  'rendimiento-por-dividendo': {
    ...
    comoLeer: 'Es bruto: a los dividendos de emisoras mexicanas se les retiene 10 por ciento como pago definitivo (LISR art. 140). Los del extranjero pagan además 10 por ciento en México (LISR art. 142, fracción V), aparte de la retención del país de origen según el tratado. No incluye el cambio de precio; para eso está el rendimiento total.',
  ...
  fibra: {
    ...
    largo: [
      ...
      'A cambio de ese reparto, la FIBRA no paga ISR a nivel del fideicomiso: el impuesto se cobra en el tenedor. A la parte de la distribución que viene del resultado fiscal se le retiene ISR a la tasa del artículo 9, 30 por ciento, según el artículo 188. Para una persona física residente en México esa retención no es el impuesto final: el ingreso se acumula en la declaración anual y lo retenido se acredita. No es el 10 por ciento de los dividendos de acciones.',
  ...
  sic: {
    ...
    largo: [
      ...
      'Para efectos fiscales, las ganancias por enajenar acciones listadas en el SIC también quedan bajo el régimen del artículo 129, con el 10 por ciento sobre la ganancia anual neta. Los dividendos de emisoras extranjeras pagan 10 por ciento en México (LISR art. 142, fracción V), además de la retención del país de origen según el tratado que corresponda.',
    ],
